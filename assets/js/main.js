...
(function ($) {
    ...
    var rtsJs = {
      ...
      methods: function (e) {
        ...
        rtsJs.jaraLux();
        rtsJs.backToTopInit();
       // rtsJs.cookiePopup(); // TEMP DISABLED: hides GDPR cookie popup
        rtsJs.datePicker();
        rtsJs.magnificPopup();
        rtsJs.mobileMenu();
        rtsJs.desktopMenu();
      ...
      swiperActivation: function(){
        $(document).ready(function(){
          ...
          // APARTMENT SLIDER (skip when markup is a static grid, e.g. index imbali-packages-grid)
      ...
      wowActive: function () {
        if (document.body && document.body.classList.contains("imbali-no-wow")) {
          return;
        }
        new WOW().init();
      },
